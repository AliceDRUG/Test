...
public class MailRuLoginTest {
    ...
    public void mailRuLoginTest() throws InterruptedException{
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Alice\\Desktop\\Test-Web-WebTest\\Test-Web-WebTest\\untitled\\drivers\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
        ...
        driver.findElement(By.xpath("//*[@class='input-0-2-71']")).sendKeys("drugtestalisa");
        driver.findElement(By.xpath("//*[@class='base-0-2-79 primary-0-2-93']")).click();
        Thread.sleep(Duration.ofSeconds(2).toMillis());

        // Вводим пароль и нажимаем на кнопку войти
        driver.findElement(By.xpath("//*[@class='input-0-2-71 withIcon-0-2-72']")).sendKeys("Adaset37");
        ...
        Assert.assertEquals("Алиса Другова",driver.findElement(By.xpath("//*[@class='ph-name svelte-1popff4']")).getText());
        driver.findElement(By.xpath("//*[@data-testid='whiteline-account-exit']")).click();
        Thread.sleep(Duration.ofSeconds(2).toMillis());
        driver.findElement(By.xpath("//*[@class='resplash-btn resplash-btn_primary resplash-btn_mailbox-big cea-fefe-ehxscg']")).isDisplayed();
